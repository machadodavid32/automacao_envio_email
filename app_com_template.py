...
mail['Subject'] = 'Deseja se inscrever?'
                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <table role="presentation" border="0" cellpadding="0"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td> <a href="https://www.portfoliododavid.com/"
                                            ...
                                            <p>Isso é um exemplo, escreva aqui algo mais se desejar</p>
                                            <p>Att, David Machado.</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="content-block">
                                    <span class="apple-link">Prtfoliododavid.com - São Paulo - BR</span>
                                    <br> Não quer mais receber estes emails? <a
